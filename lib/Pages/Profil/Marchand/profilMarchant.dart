...
class ProfilMarchand extends StatefulWidget {
  const ProfilMarchand({Key? key}) : super(key: key);

  @override
  State<ProfilMarchand> createState() => _ProfilMarchandState();
}

class _ProfilMarchandState extends State<ProfilMarchand> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Center(
            child: Text(
              "Profile Marchand",style: TextStyle(color: Colors.white,fontSize: 25),
            )
        ),
        backgroundColor: Colors.blue.shade900,
