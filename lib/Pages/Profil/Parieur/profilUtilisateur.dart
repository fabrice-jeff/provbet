        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            children: [
              ...
              Center(
                child: Text("Solde", style: TextStyle(fontSize: 20, color: Colors.blue.shade900.withOpacity(0.8))),
              ),
              Padding(
                padding: const EdgeInsets.all(8.0),
                child: Container(
                  ...
                  child: Column(
                    ...
                    children: [
                     Center(child: Text("Compte principal: $userBalance1 FCFA")),
              ...
              ListView(
                ...
                primary: false,
                children: [
                  _buildClickableListTile(context, "Recharger mon solde", () => _navigateTo(context, '/listedesnumeromarchand')),
                  _buildClickableListTile(context, "Historique de transactions", () => _navigateTo(context, '/historiquedeTranslationClient')),
                  _buildClickableListTile(context, "Historique des paris", () => _navigateTo(context, '/historiquePari')),
                  _buildClickableListTile(context, "FAQ", () => _navigateTo(context, '/faq')),
